      ...
      if (orgCode) {
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/organizations/${orgCode}`)
          ...
          .then((data: Record<string, unknown>) => {
            const hospitalTitle = typeof data.name === "string" ? data.name : `หน่วยงานรหัส: ${orgCode}`;
            setDoctorProfile(prev => prev ? { ...prev, hospitalName: hospitalTitle } : null);
          })
          .catch(() => {
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, padding: "20px 16px 48px", fontFamily: "sans-serif", color: T.text }}>
      <div style={{ maxWidth: 960, margin: "0 auto", display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        {/* Dropdown — ซ่อนเมื่อเลือกคนไข้แล้ว */}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: T.white, borderRadius: 18, border: `1px solid ${T.border}`, boxShadow: T.shadowMd, overflow: "hidden" }}>
              ...
              <div style={{ padding: "20px 24px", borderBottom: `1px solid ${T.borderLight}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 16, flex: 1 }}>
                  ...
                  <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8 }}>
                      {[
                        { label: `สูง ${selected.heightCm || "–"} ซม.` },
                        { label: `หนัก ${selected.weightKg || "–"} กก.` },
                      ].map(x => (
                      ...
                      {selected.allergies && selected.allergies.length > 0 ? (
                        ...
                        <span style={{ fontSize: 12, fontWeight: 500, background: T.bg, border: `1px solid ${T.border}`, padding: "3px 12px", borderRadius: 99, color: T.green }}>
                ...
                {/* ปุ่มเรียกใช้งาน Component ออกรายงาน PDF */}
              ...
              <div style={{ padding: "24px", background: "#fafbfc" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                    ...
                    {/* daily summary table */}
                    <Section title="สรุปโภชนาการรายวัน" icon={
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>
                    }>
                    ...
                    {/* food log table */}
                    <Section title="ประวัติการทานรายมื้อ" icon={
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m2 7 4.42-4.42a2 2 0 0 1 2.83 0l8.13 8.13a2 2 0 0 1 0 2.83L13 18" /><path d="M11.66 18.34a2 2 0 0 1-2.83 0l-5.66-5.66a2 2 0 0 1 0-2.83Z" /></svg>
                    }>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                      ...
                      <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                        ...
                        <div>
                          ...
                          <textarea required placeholder="ระบุคำแนะนำด้านโภชนาการ การออกกำลังกาย หรือการปรับพฤติกรรม..." value={recInput} onChange={e => setRecInput(e.target.value)}
                            style={{ width: "100%", minHeight: 110, padding: "10px 12px", borderRadius: 10, border: `1.5px solid ${T.border}`, background: T.bg, color: T.text, fontSize: 13, resize: "none", outline: "none", boxSizing: "border-box", transition: "border-color 0.15s", lineHeight: 1.6 }}
                        ...
                        <button type="submit" disabled={isSubmitting}
                          style={{ width: "100%", padding: "11px", borderRadius: 10, border: "none", background: isSubmitting ? T.textMuted : `linear-gradient(135deg,${T.indigo},#3730a3)`, color: "#fff", fontWeight: 700, fontSize: 14, cursor: isSubmitting ? "not-allowed" : "pointer", boxShadow: isSubmitting ? "none" : "0 4px 14px rgba(79,70,229,0.35)", transition: "all 0.2s" }}>
                    ...
                    {selected.healthRecords && selected.healthRecords.length > 0 && (
                      <Section title="ประวัติการตรวจก่อนหน้า" icon={
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" /><polyline points="14 2 14 8 20 8" /><line x1="16" x2="8" y1="13" y2="13" /></svg>
                      }>
                          ...
                          {selected.healthRecords.map(rec => (
                            <div key={rec.id} style={{ background: T.white, borderRadius: 12, border: `1px solid ${T.border}`, padding: "14px 16px", boxShadow: T.shadow, position: "relative", overflow: "hidden" }}>
                              ...
                              <div style={{ paddingLeft: 10 }}>
                                ...
                                <p style={{ margin: 0, fontSize: 13, color: T.text, lineHeight: 1.65, whiteSpace: "pre-wrap" }}>
                                  {rec.recommendation}
                                </p>
                              </div>
                            </div>
